...
\\[\blanklineskip]%
\>[B]{}\Varid{segment}\;\Varid{get}\;\Varid{eqCase}\;\Varid{stdVal}\;\Varid{pivot}\mathrel{=}\Varid{cataList}\;\alt{\underline{(\Varid{stdVal},([\mskip1.5mu \mskip1.5mu],[\mskip1.5mu \mskip1.5mu]))}}{\Varid{segv}\;\Varid{get}\;\Varid{eqCase}\;\Varid{pivot}}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{segv}\;\Varid{get}\;\Varid{eqCase}\;\Varid{pivot}\;(\Varid{h},(\Varid{e},(\Varid{s},\Varid{l}))){}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\mid \Varid{pivot}\mathbin{<}\Varid{get}\;\Varid{h}{}\<[26]%
\>[26]{}\mathrel{=}(\Varid{e},(\Varid{h}\mathbin{:}\Varid{s},\Varid{l})){}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\mid \Varid{pivot}\mathbin{>}\Varid{get}\;\Varid{h}{}\<[26]%
\>[26]{}\mathrel{=}(\Varid{e},(\Varid{s},\Varid{h}\mathbin{:}\Varid{l})){}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\mid \Varid{otherwise}{}\<[26]%
\>[26]{}\mathrel{=}\Varid{eqCase}\;\Varid{h}\;\Varid{e}\;(\Varid{s},\Varid{l}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{allTransactions}\mathrel{=}\Varid{cataBlockchain}\;(\uncurry{\Varid{ccat}}\comp \conj{\p2\comp \p2\comp \alt{\Varid{id}}{\p1}}{\alt{\Varid{nil}}{\p2}}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
...
\column{9}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{ledger}\mathrel{=}\Varid{hyloBTree}\;\Varid{preord}\;\Varid{account}\comp \Varid{cataList}\;\Varid{changes}\comp \Varid{allTransactions}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{changes}\mathrel{=}\alt{\Varid{nil}}{\Varid{cons}\comp (\Varid{id}\times\Varid{cons})\comp \Varid{assocr}\comp (\conj{\Varid{swap}\comp (\Varid{negate}\times\Varid{id})\comp \p2}{\Varid{id}\times\p1}\times\Varid{id})}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{account}\mathrel{=}\alt{i_1\comp (\mathbin{!})}{i_2\comp \Varid{condense}\comp \conj{\p1}{\uncurry{\Varid{partit}}\comp (\p1\times\Varid{id})}}\comp \Varid{outList}\;\mathbf{where}{}\<[E]%
\\[\blanklineskip]%
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{condense}\mathrel{=}\conj{\conj{\p1\comp \p1}{\uncurry{(\mathbin{+})}\comp (\p2\times\p1)}}{\p2\comp \p2}{}\<[E]%
\\[\blanklineskip]%
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{partit}\mathrel{=}\Varid{segment}\;\p1\;(\lambda \Varid{h}\;\Varid{e}\;\Varid{b}\to (\p2\;\Varid{h}\mathbin{+}\Varid{e},\Varid{b}))\;\mathrm{0}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
...
\column{9}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{isValidMagicNr}\mathrel{=}\Varid{hyloLTree}\;\alt{\Varid{id}}{\Varid{and}}\;\Varid{eqSep}\comp \Varid{cataBlockchain}\;\alt{\Varid{singl}\comp \p1}{\Varid{cons}\comp (\p1\times\Varid{id})}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{eqSep}\mathrel{=}\alt{i_1\comp \Varid{true}}{\Varid{cond}\;((\Conid{False}\equiv )\comp \p1)\;(i_1\comp \p1)\;(i_2\comp \p2)\comp \uncurry{\Varid{finders}}}\comp \Varid{outList}\;\mathbf{where}{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{finders}\mathrel{=}\Varid{segment}\;\Varid{id}\;(\underline{\cdot }\comp \underline{\cdot }\comp \underline{(\Conid{False},([\mskip1.5mu \mskip1.5mu],[\mskip1.5mu \mskip1.5mu]))})\;\Conid{True}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{5}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{operate}\;\Varid{g}\mathrel{=}\Varid{g}\times(\Varid{g}\times(\Varid{g}\times\Varid{g})){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{inQTree}\mathrel{=}\alt{\Varid{uncr3}\;\Conid{Cell}}{\Varid{uncr4}\;\Conid{Block}}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{uncr3}\;\Varid{f}\;(\Varid{a},(\Varid{b},\Varid{c}))\mathrel{=}\Varid{f}\;\Varid{a}\;\Varid{b}\;\Varid{c}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{uncr4}\;\Varid{f}\;(\Varid{a},(\Varid{b},(\Varid{c},\Varid{d})))\mathrel{=}\Varid{f}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\Varid{d}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{outQTree}\;(\Conid{Cell}\;\Varid{a}\;\Varid{b}\;\Varid{c})\mathrel{=}\Varid{cr3}\;i_1\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{cr3}\;\Varid{f}\;\Varid{a}\;\Varid{b}\;\Varid{c}\mathrel{=}\Varid{f}\;(\Varid{a},(\Varid{b},\Varid{c})){}\<[E]%
\\
\>[B]{}\Varid{outQTree}\;(\Conid{Block}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\Varid{d})\mathrel{=}\Varid{cr4}\;i_2\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\Varid{d}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{cr4}\;\Varid{f}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\Varid{d}\mathrel{=}\Varid{f}\;(\Varid{a},(\Varid{b},(\Varid{c},\Varid{d}))){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{baseQTree}\;\Varid{f}\;\Varid{g}\mathrel{=}(\Varid{f}\times\Varid{id})+\Varid{operate}\;\Varid{g}{}\<[E]%
\\
...
\column{5}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{rotateQTree}\mathrel{=}\Varid{cataQTree}\;(\Varid{inQTree}\comp ((\Varid{id}\times\Varid{swap})+\Varid{mySwap}))\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{mySwap}\;(\Varid{a},(\Varid{b},(\Varid{c},\Varid{d})))\mathrel{=}(\Varid{c},(\Varid{a},(\Varid{d},\Varid{b}))){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{5}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{scaleQTree}\;\Varid{n}\mathrel{=}\Varid{cataQTree}\;(\Varid{inQTree}\comp ((\Varid{scl}\;\Varid{n})+\Varid{id}))\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{scl}\;\Varid{n}\mathrel{=}\Varid{id}\times((\Varid{n}\mathbin{*})\times(\Varid{n}\mathbin{*})){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
...
\column{9}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{invertQTree}\mathrel{=}\mathsf{fmap}\;\Varid{inv}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{inv}\;(\Conid{PixelRGBA8}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\Varid{d})\mathrel{=}{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\mathbf{let}\;\Varid{minus}\mathrel{=}(\mathrm{255}\mathbin{-}){}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\mathbf{in}\;\Conid{PixelRGBA8}\;(\Varid{minus}\;\Varid{a})\;(\Varid{minus}\;\Varid{b})\;(\Varid{minus}\;\Varid{c})\;\Varid{d}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
...
\column{13}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{compressQTree}\mathrel{=}\Varid{flip}\;(\cata{\cdot }\comp \uncurry{\alt{\cdot }{\cdot }}\comp \conj{\underline{\cdot }}{\underline{\Varid{compressUnit}}})\;\mathbf{where}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\hsindent{9}{}\<[9]%
\>[9]{}\Varid{compressUnit}\mathrel{=}{}\<[E]%
\\
\>[9]{}\hsindent{4}{}\<[13]%
\>[13]{}\mathbf{let}\;\Varid{g}\mathrel{=}\Varid{cond}\;\Varid{evCell}\;(i_1\comp \Varid{mjoin}\comp (\Varid{id}\times(\p2\comp \p2)))\;i_2{}\<[E]%
\\
\>[9]{}\hsindent{4}{}\<[13]%
\>[13]{}\mathbf{in}\;\Varid{anaQTree}\;(\alt{i_1}{\Varid{g}}\comp \Varid{outQTree}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\hsindent{9}{}\<[9]%
\>[9]{}\Varid{mjoin}\;(\Conid{Cell}\;\Varid{a1}\;\Varid{b1}\;\Varid{c1},\Conid{Cell}\;\Varid{a2}\;\Varid{b2}\;\Varid{c2})\mathrel{=}(\Varid{a1},(\Varid{b1}\mathbin{+}\Varid{b2},\Varid{c1}\mathbin{+}\Varid{c2})){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\hsindent{9}{}\<[9]%
\>[9]{}\Varid{evCell}\mathrel{=}(\lambda (\Varid{a},(\Varid{b},(\Varid{c},\Varid{d})))\to \Varid{a}\mathrel{\wedge}\Varid{b}\mathrel{\wedge}\Varid{c}\mathrel{\wedge}\Varid{d})\comp \Varid{operate}\;(\alt{\Varid{true}}{\Varid{false}}\comp \Varid{outQTree}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
...
\column{13}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{outlineQTree}\;\Varid{f}\mathrel{=}\uncurry{(\Varid{elementwise}\;(\Varid{curry}\;(\Varid{cond}\;\p1\;\p2\;\p1)))}\comp \Varid{cataQTree}\;\alt{\Varid{baser}\;\Varid{f}}{\Varid{mulkernel}}\;\mathbf{where}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\hsindent{9}{}\<[9]%
\>[9]{}\Varid{baser}\;\Varid{f}\;(\Varid{k},(\Varid{i},\Varid{j}))\mathrel{=}(matrix\;\Varid{j}\;\Varid{i}\;\Varid{false},matrix\;\Varid{j}\;\Varid{i}\;\underline{(\Varid{f}\;\Varid{k})}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\hsindent{9}{}\<[9]%
\>[9]{}\Varid{mulkernel}\mathrel{=}(\Varid{engage}\;\Varid{border}\times\Varid{engage}\;\Varid{id})\comp \conj{\Varid{operate}\;\p1}{\Varid{operate}\;\p2}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\hsindent{9}{}\<[9]%
\>[9]{}\Varid{engage}\;\Varid{f}\mathrel{=}(\lambda (\Varid{a},(\Varid{b},(\Varid{c},\Varid{d})))\to (\Varid{a}{\,\updownarrow\,}\Varid{b}){\,\leftrightarrow\,}(\Varid{c}{\,\updownarrow\,}\Varid{d}))\comp \Varid{operate}\;\Varid{f}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\hsindent{9}{}\<[9]%
\>[9]{}\Varid{border}\mathrel{=}{}\<[E]%
\\
\>[9]{}\hsindent{4}{}\<[13]%
\>[13]{}\mathbf{let}\;\Varid{drawQ}\;\Varid{funct}\;\Varid{f}\;\Varid{par}\mathrel{=}\uncurry{(\Varid{funct}\;\Varid{f})}\comp \conj{\Varid{par}}{\Varid{funct}\;\Varid{f}\;\mathrm{1}}{}\<[E]%
\\
\>[9]{}\hsindent{4}{}\<[13]%
\>[13]{}\mathbf{in}\;\Varid{drawQ}\;\Varid{mapCol}\;\underline{\Varid{true}}\;\Varid{ncols}\comp \Varid{drawQ}\;\Varid{mapRow}\;\underline{\Varid{true}}\;\Varid{nrows}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
%
\ensuremath{\begin{lcbr}(\Varid{f}\;\Varid{k})\comp \Varid{zero}\mathrel{=}\Varid{one}\\(\Varid{f}\;\Varid{k})\comp (\succ \;\Varid{d})\mathrel{=}\Varid{mul}\;((\Varid{f}\;\Varid{k})\;\Varid{d},(\Varid{l}\;\Varid{k})\;\Varid{d})\end{lcbr}}
%
...
\just\equiv{ Eq-+ (27) }
%
\ensuremath{\alt{(\Varid{f}\;\Varid{k})\comp \Varid{zero}}{(\Varid{f}\;\Varid{k})\comp \succ }\mathrel{=}\alt{\Varid{one}}{\Varid{mul}\comp \conj{\Varid{f}\;\Varid{k}}{\Varid{l}\;\Varid{k}}}}
%
\just\equiv{ Fusão-+ (20); Absorção-+ (22); Natural-id (1) }
%
\ensuremath{(\Varid{f}\;\Varid{k})\comp \alt{\Varid{zero}}{\succ }\mathrel{=}\alt{\Varid{one}}{\Varid{mul}}\comp (\Varid{id}\mathbin{+}\conj{\Varid{f}\;\Varid{k}}{\Varid{l}\;\Varid{k}})}
%
\just\equiv{ (either zero succ) = inNat; F(f) = id + f }
%
\ensuremath{(\Varid{f}\;\Varid{k})\comp \mathbf{in}\mathrel{=}\alt{\Varid{one}}{\Varid{mul}}\comp \Conid{F}\;\conj{\Varid{f}\;\Varid{k}}{\Varid{l}\;\Varid{k}}}
\qed
\end{eqnarray*}
...
%
\ensuremath{\begin{lcbr}(\Varid{l}\;\Varid{k})\comp \Varid{zero}\mathrel{=}\succ \comp \underline{\Varid{k}}\\\Varid{l}\;\Varid{k}\comp (\succ \;\Varid{d})\mathrel{=}\succ \comp ((\Varid{l}\;\Varid{k})\;\Varid{d})\end{lcbr}}
%
\just\equiv{ Fusão-const (3); Cancelamento-x (7); Igualdade extensional (73) }
%
\ensuremath{\begin{lcbr}(\Varid{l}\;\Varid{k})\comp \Varid{zero}\mathrel{=}\underline{(\succ \;\Varid{k})}\\(\Varid{l}\;\Varid{k})\comp \succ \mathrel{=}\succ \comp \p2\comp \conj{\Varid{f}\;\Varid{k}}{\Varid{l}\;\Varid{k}}\end{lcbr}}
%
\just\equiv{ Eq-+ (27) }
%
\ensuremath{\alt{(\Varid{l}\;\Varid{k})\comp \Varid{zero}}{(\Varid{l}\;\Varid{k})\comp \succ }\mathrel{=}\alt{\underline{(\succ \;\Varid{k})}}{\succ \comp \p2\comp \conj{\Varid{f}\;\Varid{k}}{\Varid{l}\;\Varid{k}}}}
%
\just\equiv{ Fusão-+ (20); Absorção-+ (22); Natural-id (1 }
%
\ensuremath{(\Varid{l}\;\Varid{k})\comp \alt{\Varid{zero}}{\succ }\mathrel{=}\alt{\underline{(\succ \;\Varid{k})}}{\succ \comp \p2}\comp (\Varid{id}\mathbin{+}\conj{\Varid{f}\;\Varid{k}}{\Varid{l}\;\Varid{k}})}
%
\just\equiv{ (either zero succ) = inNat; F(f) = id + f }
%
...
\begin{eqnarray*}
\start
\ensuremath{\begin{lcbr}(\Varid{f}\;\Varid{k})\comp \mathbf{in}\mathrel{=}\alt{\Varid{one}}{\Varid{mul}}\comp \Conid{F}\;\conj{\Varid{f}\;\Varid{k}}{\Varid{l}\;\Varid{k}}\\(\Varid{l}\;\Varid{k})\comp \mathbf{in}\mathrel{=}\alt{\underline{(\succ \;\Varid{k})}}{\succ \comp \p2}\comp \Conid{F}\;\conj{\Varid{f}\;\Varid{k}}{\Varid{l}\;\Varid{k}}\end{lcbr}}
%
\just\equiv{ Fokkinga (50) }
%
\ensuremath{\conj{\Varid{f}\;\Varid{k}}{\Varid{l}\;\Varid{k}}\mathrel{=}\cata{\conj{\alt{\Varid{one}}{\Varid{mul}}}{\alt{\underline{(\succ \;\Varid{k})}}{\succ \comp \p2}}}}
%
\just\equiv{ Lei da troca (28) }
%
\ensuremath{\conj{\Varid{f}\;\Varid{k}}{\Varid{l}\;\Varid{k}}\mathrel{=}\cata{\alt{\conj{\Varid{one}}{\underline{(\succ \;\Varid{k})}}}{\conj{\Varid{mul}}{\succ \comp \p2}}}}
%
\just\equiv{ (split (const a) (const b)) = const (a,b) }
%
\ensuremath{\conj{\Varid{f}\;\Varid{k}}{\Varid{l}\;\Varid{k}}\mathrel{=}\cata{\alt{\underline{(\mathrm{1},\succ \;\Varid{k})}}{\conj{\Varid{mul}}{\succ \comp \p2}}}}
\qed
\end{eqnarray*}
...
%
\ensuremath{\begin{lcbr}\Varid{g}\comp \Varid{zero}\;\Varid{d}\mathrel{=}\Varid{one}\;\Varid{d}\\\Varid{g}\comp \succ \;\Varid{d}\mathrel{=}\Varid{mul}\;(\Varid{g}\;\Varid{d},\Varid{s}\;\Varid{d})\end{lcbr}}
%
\just\equiv{ Igualdade extensional (73); Def-split (78) }
%
\ensuremath{\begin{lcbr}\Varid{g}\comp \Varid{zero}\mathrel{=}\Varid{one}\\\Varid{g}\comp \succ \mathrel{=}\Varid{mul}\comp \conj{\Varid{g}}{\Varid{s}}\end{lcbr}}
%
\just\equiv{ Eq-+ (27) }
%
\ensuremath{\alt{\Varid{g}\comp \Varid{zero}}{\Varid{g}\comp \succ }\mathrel{=}\alt{\Varid{one}}{\Varid{mul}\comp \conj{\Varid{g}}{\Varid{s}}}}
%
\just\equiv{ Fusão-+ (20); Absorção-+ (22); Natural-id (1) }
%
\ensuremath{\Varid{g}\comp \alt{\Varid{zero}}{\succ }\mathrel{=}\alt{\Varid{one}}{\Varid{mul}}\comp (\Varid{id}\mathbin{+}\conj{\Varid{g}}{\Varid{s}})}
%
\just\equiv{ (either zero succ) = inNat; F(f) = id + f }
%
\ensuremath{\Varid{g}\comp \mathbf{in}\mathrel{=}\alt{\Varid{one}}{\Varid{mul}}\comp \Conid{F}\;\conj{\Varid{g}}{\Varid{s}}}
\qed
\end{eqnarray*}
...
%
\ensuremath{\begin{lcbr}\Varid{s}\comp \Varid{zero}\;\Varid{d}\mathrel{=}\Varid{one}\;\Varid{d}\\\Varid{s}\comp \succ \;\Varid{d}\mathrel{=}\succ \;(\Varid{s}\;\Varid{d})\end{lcbr}}
%
\just\equiv{ Igualdade extensional (73)}
%
\ensuremath{\begin{lcbr}\Varid{s}\comp \Varid{zero}\mathrel{=}\Varid{one}\\\Varid{s}\comp \succ \mathrel{=}\succ \comp \Varid{s}\end{lcbr}}
%
...
\just\equiv{ Eq-+ (27) }
%
\ensuremath{\Varid{s}\comp \alt{\Varid{zero}}{\succ }\mathrel{=}\alt{\Varid{one}}{\succ \comp \p2\comp \conj{\Varid{g}}{\Varid{s}}}}
%
\just\equiv{ Eq-+ (27) }
%
\ensuremath{\Varid{s}\comp \mathbf{in}\mathrel{=}\alt{\Varid{one}}{\succ \comp \p2}\comp \Conid{F}\;\conj{\Varid{g}}{\Varid{s}}}
\qed
\end{eqnarray*}
...
\begin{eqnarray*}
\start
\ensuremath{\begin{lcbr}\Varid{g}\comp \mathbf{in}\mathrel{=}\alt{\Varid{one}}{\Varid{mul}}\comp (\Conid{F}\;\conj{\Varid{g}}{\Varid{s}})\\\Varid{s}\comp \mathbf{in}\mathrel{=}\alt{\Varid{one}}{\succ \comp \p2}\comp (\Conid{F}\;\conj{\Varid{g}}{\Varid{s}})\end{lcbr}}
%
\just\equiv{ Fokkinga (50) }
%
...
\just\equiv{ (split (const a) (const b)) = const (a,b) }
%
\ensuremath{\conj{\Varid{g}}{\Varid{s}}\mathrel{=}\cata{\alt{\underline{(\mathrm{1},\mathrm{1})}}{\conj{\Varid{mul}}{\succ \comp \p2}}}}
\qed
\end{eqnarray*}
...
\just\cong { Enunciado }
%
\ensuremath{\conj{\conj{\Varid{f}}{\Varid{l}}}{\conj{\Varid{g}}{\Varid{s}}}}
%
\just= { Demonstrações anteriores}
%
\ensuremath{\conj{\cata{\alt{\conj{\Varid{one}}{\underline{(\succ \;\Varid{k})}}}{\conj{\Varid{mul}}{\succ \comp \p2}}}}{\cata{\alt{\conj{\Varid{one}}{\Varid{one}}}{\conj{\Varid{mul}}{\succ \comp \p2}}}}}
%
\just={ Lei de banana-split (51) }
%
\ensuremath{\cata{(\alt{\conj{\Varid{one}}{\underline{(\succ \;\Varid{k})}}}{\conj{\Varid{mul}}{\succ \comp \p2}}\times\alt{\conj{\Varid{one}}{\Varid{one}}}{\conj{\Varid{mul}}{\succ \comp \p2}})\comp \conj{\Varid{id}\mathbin{+}\p1}{\Varid{id}\mathbin{+}\p2}}}
%
\just={ Absorção-x (11) }
%
\ensuremath{\cata{\conj{\alt{\conj{\Varid{one}}{\underline{(\succ \;\Varid{k})}}}{\conj{\Varid{mul}}{\succ \comp \p2}}\comp (\Varid{id}\mathbin{+}\p1)}{\alt{\conj{\Varid{one}}{\Varid{one}}}{\conj{\Varid{mul}}{\succ \comp \p2}}\comp (\Varid{id}\mathbin{+}\p2)}}}
%
\just={ Absorção-+ (22); Natural-id (1) }
%
\ensuremath{\cata{\conj{\alt{\conj{\Varid{one}}{\underline{(\succ \;\Varid{k})}}}{\conj{\Varid{mul}}{\succ \comp \p2}\comp \p1}}{\alt{\conj{\Varid{one}}{\Varid{one}}}{\conj{\Varid{mul}}{\succ \comp \p2}\comp \p2}}}}
%
\just={ Lei da troca (28) }
%
\ensuremath{\cata{\alt{\conj{\conj{\Varid{one}}{\underline{(\succ \;\Varid{k})}}}{\conj{\Varid{one}}{\Varid{one}}}}{\conj{\Varid{mul}}{\succ \comp \p2}\times\conj{\Varid{mul}}{\succ \comp \p2}}}}
%
\just={ (split (const a) (const b)) = const (a,b) }
%
\ensuremath{\cata{\alt{\underline{((\mathrm{1},\Varid{k}\mathbin{+}\mathrm{1}),(\mathrm{1},\mathrm{1}))}}{\conj{\Varid{mul}}{\succ \comp \p2}\times\conj{\Varid{mul}}{\succ \comp \p2}}}}
%
\just={ for b i = cataNat (either (const i) b) }
%
\ensuremath{\mathsf{for}\ (\conj{\Varid{mul}}{\succ \comp \p2}\times\conj{\Varid{mul}}{\succ \comp \p2})\ ((\mathrm{1},\Varid{k}\mathbin{+}\mathrm{1}),(\mathrm{1},\mathrm{1}))}
\qed
\end{eqnarray*}
...
\begin{eqnarray*}
\ensuremath{\Varid{flat}\comp \Varid{unflat}\mathrel{=}\Varid{unflat}\comp \Varid{flat}\mathrel{=}\Varid{id}}
\end{eqnarray*}

\begin{eqnarray*}
\xymatrix@C=2cm{
    \ensuremath{\Conid{A}\times\Conid{A}\times\Conid{A}\times\Conid{A}}
        \ar[r]^-{\ensuremath{\Varid{flat}}}
&
    \ensuremath{(\Conid{A}\times\Conid{A})\times(\Conid{A}\times\Conid{A})}
           \ar[l]^-{\ensuremath{\Varid{unflat}}}
}
\end{eqnarray*}
...
\\
\>[B]{}\Varid{loop}\mathrel{=}\Varid{flat}\comp (\Varid{p}\times\Varid{p})\comp \Varid{unflat}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{flat}\;((\Varid{a},\Varid{b}),(\Varid{c},\Varid{d}))\mathrel{=}(\Varid{a},\Varid{b},\Varid{c},\Varid{d}){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{unflat}\;(\Varid{a},\Varid{b},\Varid{c},\Varid{d})\mathrel{=}((\Varid{a},\Varid{b}),(\Varid{c},\Varid{d})){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{p}\mathrel{=}\conj{\Varid{mul}}{\succ \comp \p2}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{inFTree}\;(i_1\;\Varid{x})\mathrel{=}\Conid{Unit}\;\Varid{x}{}\<[E]%
\\
\>[B]{}\Varid{inFTree}\;(i_2\;(\Varid{x},(\Varid{a},\Varid{b})))\mathrel{=}\Conid{Comp}\;\Varid{x}\;\Varid{a}\;\Varid{b}{}\<[E]%
\\
\>[B]{}\Varid{outFTree}\;(\Conid{Unit}\;\Varid{x})\mathrel{=}i_1\;\Varid{x}{}\<[E]%
\\
\>[B]{}\Varid{outFTree}\;(\Conid{Comp}\;\Varid{x}\;{}\<[19]%
\>[19]{}\Varid{a}\;\Varid{b})\mathrel{=}i_2\;(\Varid{x},(\Varid{a},\Varid{b})){}\<[E]%
\\
\>[B]{}\Varid{recFTree}\mathrel{=}\Varid{baseFTree}\;\Varid{id}\;\Varid{id}{}\<[E]%
\\
...
\\
\>[B]{}\Varid{baseFTree}\;\Varid{f}\;\Varid{o}\;\Varid{g}\mathrel{=}\Varid{o}+(\Varid{f}\times(\Varid{g}\times\Varid{g})){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mathbf{instance}\;\Conid{Bifunctor}\;\Conid{FTree}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{bimap}\;\Varid{f}\;\Varid{g}\mathrel{=}{}\<[18]%
\>[18]{}\Varid{cataFTree}\;(\Varid{inFTree}\comp \Varid{baseFTree}\;\Varid{f}\;\Varid{g}\;\Varid{id}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
...
\column{20}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{generatePTree}\mathrel{=}{}\<[18]%
\>[18]{}\Varid{modifyPTree}\comp \Varid{anaFTree}\;\Varid{gene}\comp \Varid{toInteger}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{gene}\mathrel{=}((\Varid{\Conid{Cp}.zero})+\conj{\succ }{\conj{\Varid{id}}{\Varid{id}}})\comp \Varid{outNat}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{modifyPTree}\mathrel{=}\Varid{\Conid{Cp}.ap}\comp ((\Varid{\Conid{Cp}.ap}\comp (\Varid{\Conid{Cp}.ap}\times\Varid{id})\comp \Varid{assocl})\times\Varid{id})\comp \conj{\conj{\underline{\Varid{bimap}}}{\Varid{dup}\comp \Varid{submax}}}{\Varid{id}}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{submax}\;\Varid{x}\mathrel{=}{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\mathbf{let}\;\Varid{valor}{}\<[20]%
\>[20]{}\mathrel{=}\alt{\Varid{id}}{\p1}\comp \Varid{outFTree}{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\mathbf{in}\;{}\<[13]%
\>[13]{}\uncurry{(\mathbin{**})}\comp \conj{\underline{(\Varid{sqrt}\;\mathrm{2}\mathbin{/}\mathrm{2})}}{\Varid{fromIntegral}\comp \uncurry{(\mathbin{-})}\comp \conj{\underline{(\Varid{valor}\;\Varid{x})}}{\Varid{id}}}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
...
\column{13}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{drawPTree}\mathrel{=}\Varid{cataFTree}\;\alt{\Varid{singl}\comp \Varid{square}}{\Varid{cons}\comp (\Varid{square}\times\mathsf{conc})\comp \Varid{visualTransformation}}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{9}{}\<[9]%
\>[9]{}\Varid{visualTransformation}\mathrel{=}{}\<[E]%
\\
\>[9]{}\hsindent{4}{}\<[13]%
\>[13]{}\mathbf{let}\;\Varid{pad}\;\Varid{x}\;\Varid{y}\mathrel{=}\mathsf{fmap}\comp \uncurry{(\comp )}\comp \conj{\uncurry{\Varid{translate}}\comp \conj{\Varid{x}}{\Varid{id}}}{\underline{(\Varid{rotate}\;(\Varid{y}\;\mathrm{45}))}}{}\<[E]%
\\
\>[9]{}\hsindent{4}{}\<[13]%
\>[13]{}\mathbf{in}\;\conj{\p1}{(\uncurry{(\Varid{pad}\;(\Varid{negate}\comp (\mathbin{/}\mathrm{2}))\;\Varid{negate})}\times\uncurry{(\Varid{pad}\;(\mathbin{/}\mathrm{2})\;\Varid{id})})\comp \conj{\Varid{id}\times\p1}{\Varid{id}\times\p2}}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\[\blanklineskip]%
\>[B]{}\Varid{special}\;\Varid{f}\mathrel{=}\map \;(\Varid{id}\times\Varid{f})\comp \Varid{unB}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mu \mathrel{=}\mathit B\comp \Varid{concatMap}\;(\Varid{\Conid{Cp}.ap}\comp \Varid{swap}\comp (\Varid{id}\times\Varid{special}\comp (\mathbin{*})))\comp \Varid{unB}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{dist}\mathrel{=}\Conid{D}\comp \uncurry{\Varid{special}}\comp \conj{\Varid{divide}\comp \Varid{soma}}{{}\<[53]%
\>[53]{}\Varid{id}}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{soma}\mathrel{=}\Varid{cataList}\;\alt{\underline{\mathrm{0}}}{\uncurry{(\mathbin{+})}\comp (\p2\times\Varid{id})}\comp \Varid{unB}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{divide}\mathrel{=}\Varid{curry}\;(\uncurry{(\mathbin{/})}\comp (\Varid{toFloat}\times\Varid{toFloat})\comp \Varid{swap}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
